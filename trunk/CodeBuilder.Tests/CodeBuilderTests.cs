...
namespace CodeBuilder.Tests
{
    ...
    public class CodeBuilderTests
    {
        ...
        public void GenerateORM()
        {
            ...
            projectBuilder.OnBuildStep += new ProjectBuilderEventHandler(projectBuilder_OnBuildStep);
            projectBuilder.Build();
            Assert.AreEqual(File.Exists(out_file_dll), true);
        }

        void projectBuilder_OnBuildStep(object sender, ProjectBuilderEventArgs e)
        {
            if (e.MessageType == ProjectBuilderMessageType.Error)
            {
