...
namespace PGORM.PostgreSQL
{
    public class CodeHelper
    {
        ...
        {
            File.WriteAllText(@"C:\Users\Gevik\WorkDir\PGORM\PGORM.PostgreSQL\Catalog\pg_relation.cs", CodeHelper.table_to_cs(SQLScripts.GetAllTablesViews, "pg_relation"));
            File.WriteAllText(@"C:\Users\Gevik\WorkDir\PGORM\PGORM.PostgreSQL\Catalog\pg_column.cs", CodeHelper.table_to_cs(SQLScripts.GetAllColumns, "pg_column"));
